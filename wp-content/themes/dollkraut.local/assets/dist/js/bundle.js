...
},{"jquery":1,"swiper":2}],4:[function(require,module,exports){
"use strict";
    ...
    website: function website() {
      ...
      $links.each(function (index) {
        $(this).click(function (e) {
          ...
          e.preventDefault(); // remove active class from all active menu items

          $('.header-wrapper .primary a').removeClass('is-active'); // add active class to the clicked menu items

          $(this).addClass('is-active'); // remove active class from all active pages

          $('.page').removeClass('is-active'); // get index of this menu item

          var $index = $(this).data('index'); // loop over all pages, find the matching index, add active class
...
},{"./modules/sliders":3,"./modules/theme":4,"jquery":1}]},{},[5]);
